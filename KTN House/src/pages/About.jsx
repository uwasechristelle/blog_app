          ...
          <div className="abt">
            ...
            <div className="abttext">
              <p>
                ...
                eius, aliquam animi aspernatur ipsum ex inventore illo,
                obcaecati fugit perferendis eum deserunt? Ab eum quidem culpa
                quas odio est autem modi voluptatum optio amet, facere beatae ea
                magnam, suscipit tempora. Perspiciatis, adipisci! Earum.
              </p>
            </div>
            <div className="time">
              <div className="open">
          ...
          <div className="ourservices">
            <div className="services">
              ...
              <div className="service-body">
                ...
                <p>
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Porro eos magnam repellat molestiae beatae quam aut id non
                  voluptas similique!
                </p>
              </div>
            </div>
